...
// Aliases of "cp852": the names Python accepts for its codec "cp852"
static const char *const cp852_aliases[] = {"852", "cspcp852", "ibm852"};
...
void Cp852ToUtf::Register(const DBConfig &config) {
	...
	for (const auto *alias : cp852_aliases) {
