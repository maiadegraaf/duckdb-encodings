...
static const map_entry_encoding macos_21_10_5_to_utf8[] = {
    ...
    {1, "\x7E", 1, "\x7E"},         {1, "\x7F", 1, "\x7F"},         {1, "\x80", 2, "\xC2\xAB"},
    {1, "\x81", 2, "\xC2\xBB"},     {1, "\x82", 3, "\xE2\x80\xA6"}, {1, "\x8D", 3, "\xE2\x80\x9C"},
    {1, "\x8E", 3, "\xE2\x80\x9D"}, {1, "\x91", 3, "\xE2\x80\xA2"}, {1, "\x9D", 3, "\xE2\x80\x98"},
    {1, "\x9E", 3, "\xE2\x80\x99"}, {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xE0\xB8\x81"},
    ...
    {1, "\xDB", 3, "\xE2\x81\xA0"}, {1, "\xDC", 3, "\xE2\x80\x8B"}, {1, "\xDD", 3, "\xE2\x80\x93"},
    {1, "\xDE", 3, "\xE2\x80\x94"}, {1, "\xDF", 3, "\xE0\xB8\xBF"}, {1, "\xE0", 3, "\xE0\xB9\x80"},
    ...
    {1, "\xED", 3, "\xE0\xB9\x8D"}, {1, "\xEE", 3, "\xE2\x84\xA2"}, {1, "\xEF", 3, "\xE0\xB9\x8F"},
    ...
    {1, "\xF9", 3, "\xE0\xB9\x99"}, {1, "\xFA", 2, "\xC2\xAE"},     {1, "\xFB", 2, "\xC2\xA9"},
};
