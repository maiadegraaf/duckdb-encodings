...
// Aliases of "cp865": the names Python accepts for its codec "cp865"
static const char *const cp865_aliases[] = {"865", "csibm865", "ibm865"};
...
void Cp865ToUtf::Register(const DBConfig &config) {
	...
	for (const auto *alias : cp865_aliases) {
