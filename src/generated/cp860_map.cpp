...
// Aliases of "cp860": the names Python accepts for its codec "cp860"
static const char *const cp860_aliases[] = {"860", "csibm860", "ibm860"};
...
void Cp860ToUtf::Register(const DBConfig &config) {
	...
	for (const auto *alias : cp860_aliases) {
