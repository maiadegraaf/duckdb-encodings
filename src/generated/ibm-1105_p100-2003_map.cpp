...
static const map_entry_encoding ibm_1105_P100_2003_to_utf8[] = {
    ...
    {1, "\x40", 2, "\xC3\x84"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"},     {1, "\x43", 1, "\x43"},
    ...
    {1, "\x5C", 2, "\xC3\x98"}, {1, "\x5D", 2, "\xC3\x85"}, {1, "\x5E", 2, "\xC3\x9C"}, {1, "\x5F", 1, "\x5F"},
    {1, "\x60", 2, "\xC3\xA4"}, {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},     {1, "\x63", 1, "\x63"},
    ...
    {1, "\x7C", 2, "\xC3\xB8"}, {1, "\x7D", 2, "\xC3\xA5"}, {1, "\x7E", 2, "\xC3\xBC"}, {1, "\x7F", 1, "\x7F"},
};
