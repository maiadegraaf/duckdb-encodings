...
// Aliases of "cp863": the names Python accepts for its codec "cp863"
static const char *const cp863_aliases[] = {"863", "csibm863", "ibm863"};
...
void Cp863ToUtf::Register(const DBConfig &config) {
	...
	for (const auto *alias : cp863_aliases) {
